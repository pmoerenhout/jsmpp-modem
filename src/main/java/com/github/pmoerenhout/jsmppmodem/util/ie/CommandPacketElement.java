...
public class CommandPacketElement extends InformationElement {

  CommandPacketElement(final byte id, final byte[] data) {
    super(id, data);
    if (getIdentifier() != IEI_COMMAND_PACKET_HEADER) {
